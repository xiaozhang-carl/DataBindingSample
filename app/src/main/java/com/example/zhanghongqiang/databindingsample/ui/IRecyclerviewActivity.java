...
import com.example.zhanghongqiang.databindingsample.databinding.ActivityIRecyclerviewBinding;
...
import com.example.zhanghongqiang.databindingsample.presenter.IRecyclerViewPresenter;
 ...
 * ToDo:
 */
public class IRecyclerviewActivity extends BaseActivity implements RecyclerViewContract.IFLoadData, RecyclerViewContract.IFAdapter<Movie> {

    private ActivityIRecyclerviewBinding binding;
    //布局填充器
    private LayoutInflater inflater;
    //列表代理
    private IRecyclerViewPresenter recyclerViewPresenter;
